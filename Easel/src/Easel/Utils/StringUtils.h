...
namespace Easel {
	...
	namespace StringUtils {
		...
		std::vector<std::string> EASEL_EXPORT SplitString(const std::string& string, const std::string& delimiters);
		std::vector<std::string> EASEL_EXPORT SplitString(const std::string& string, const char delimiter);
		std::vector<std::string> EASEL_EXPORT Tokenize(const std::string& string);
