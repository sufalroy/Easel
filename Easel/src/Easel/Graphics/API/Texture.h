...
namespace Easel {
	...
	namespace Graphics {
		...
		class EASEL_EXPORT Texture2D : public Texture {
		public:
		...
		class EASEL_EXPORT TextureCube : public Texture {
		protected:
		...
		class EASEL_EXPORT TextureDepth : public Texture {
		public:
		...
		class EASEL_EXPORT TextureDepthArray : public Texture {
		public:
