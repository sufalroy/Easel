...
namespace Easel {
	...
	namespace Graphics {
		...
		uint32_t GLTools::TextureFormatToGL(TextureFormat format, bool srgb) {
			...
			default:
				EASEL_ASSERT(false, "[Texture] Unsupported TextureFormat");
				return 0;
			}
		}
		...
		uint32_t GLTools::TextureWrapToGL(TextureWrap wrap) {
			...
			default:
				EASEL_ASSERT(false, "[Texture] Unsupported TextureWrap");
				return 0;
			}
		}
		...
		uint32_t GLTools::TextureFormatToInternalFormat(uint32_t format) {
			...
			default:
				EASEL_ASSERT(false, "[Texture] Unsupported Texture Format");
				return 0;
			}
		}
		...
		uint32_t GLTools::StencilTypeToGL(const StencilType type) {
			...
			default:
				EASEL_ASSERT(false, "Unsupported StencilType");
				return 0;
			}
		}
		...
		uint32_t GLTools::DataTypeToGL(DataType dataType) {
			...
			default:
				EASEL_CORE_ERROR("Unsupported DataType"); 
				break;
			}
			return 0;
		}
		...
		uint32_t GLTools::DrawTypeToGL(DrawType drawType) {
			...
			default:
				EASEL_CORE_ERROR("Unsupported DrawType");
				break;
			}
			return 0;
		}
